...

{
	...
	public  function delete_exam($id){
		...
		public  function get_student_withmarks_list($s_id,$class_id,$subject_id,$exam_id){
			$this->db->select('users.name,users.roll_number,exam_marks_list.marks_obtained,exam_marks_list.max_marks,exam_marks_list.remarks,class_subjects.subject,exam_list.exam_type')->from('exam_marks_list');
