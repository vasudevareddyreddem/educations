...

{
	...
	$this->db->select('users.name as username,books_list.book_number,class_list.name,class_list.section,book_damage.return_type,book_damage.price,book_damage.create_at')->from('book_damage');
