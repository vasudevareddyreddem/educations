      ...
      <div class="row">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="<?php if(isset($tab) && $tab==''){  echo "active";} ?>"><a href="#tab_1" data-toggle="tab">Add Routes and Stops</a></li>
               ...
               <li class="<?php if(isset($tab) && $tab==1){  echo "active";} ?>"><a href="#tab_2" data-toggle="tab">Routes and Stops List
        ...
        <div class="control-group" id="fields">
            ...
            <div class="controls"> 
                ...
                <form id="" name="defaultForm" method="post"  action="<?php echo base_url('transportation/addroutepost'); ?>">
					...
					<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input class="form-control" name="route_no" type="text" placeholder="Enter Route Number"  required>		
                    ...
                    <div class="entry input-group col-md-6 ">
                       ...
                       <input class="form-control" name="route_stops[]" type="text" placeholder="Enter Route Name"  required>						
		...
		<div class="clearfix"> </div>
            ...
            <div class="box-body table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php if(isset($roues_stops_list) && count($roues_stops_list)>0){ ?>

                <tbody>

				<?php foreach($roues_stops_list as $list){ ?>
					...
					<tr>
					  ...
					  <?php if(isset($list['stops_list']) && count($list['stops_list'])>0){ ?>

					  <?php foreach($list['stops_list'] as $lis){ ?>
