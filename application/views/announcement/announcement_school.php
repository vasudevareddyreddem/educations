...
<div class="content-wrapper">
   <section class="content">
                              ...
                              <div class="row">
                                 <div class="col-md-5   card dat-help">
                                  <div class="panel " style="border:1px solid #ddd; ">
                                    ...
                                    <textarea  id="example-console" type="textarea" class="form-control"  placeholder="Selected Resources" ></textarea>
                                 ...
                                 <div class="col-md-7 chat-help">
                                    <div class="panel " style="border:1px solid #ddd">
									   ...
									   <form id="addnotifications" action="<?php echo base_url('Announcement/resourcecomments'); ?>" method="POST" >
                                       <div class="panel-body">
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingOne">
									<h4 class="panel-title">
										<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $list['int_id']; ?>" aria-expanded="true" aria-controls="collapseOne">
								...
								<div id="collapseOne<?php echo $list['int_id']; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
									<div class="panel-body">
	...
	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
          ...
          <?php if(isset($send_notification_list) && count($send_notification_list)>0){ ?> 
		  <?php foreach($send_notification_list as $List){ ?>
        <div class="panel panel-default">
