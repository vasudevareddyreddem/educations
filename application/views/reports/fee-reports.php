 <?php if(isset($fee_reports)&& count($fee_reports)>0){?>
<div class="box-body table-responsive" style="background:#fff;">
<a target="_blank" href="<?php echo base_url('reports/feeprint');?>"  style="float:right;" class="btn btn-primary">Print</a>
               ...
               <tr>
						...
						<tbody>
						<?php $cnt=1; foreach($fee_reports as $list){?>
						<tr>
