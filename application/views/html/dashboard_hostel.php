      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo isset($rooms_count['room_count'])?$rooms_count['room_count']:'';?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo isset($beds_count['bed_count'])?$beds_count['bed_count']:'';?><sup style="font-size: 20px"></sup></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo isset($student_count_data['student_data'])?$student_count_data['student_data']:'';?></h3>
