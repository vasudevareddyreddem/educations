      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo isset($student_count['stu_count'])?$student_count['stu_count']:'';?></h3>
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo isset($parent_count['person_count'])?$parent_count['person_count']:'';?></h3>
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo isset($fee_sum['total_amount'])?$fee_sum['total_amount']:'';?></h3>
