      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo isset($total_amount['total'])?$total_amount['total']:'';?></h3>
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo isset($pay_amount['pay'])?$pay_amount['pay']:'';?><sup style="font-size: 20px"></sup></h3>
		...
		<div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo isset($due_amount['due'])?$due_amount['due']:'';?><sup style="font-size: 20px"></sup></h3>
