					...
					<?php $csrf = array(
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="">
									<input type="text" class="form-control" name="qalification" id="qalification" value="<?php echo isset($userdetails['qalification'])?$userdetails['qalification']:''; ?>" placeholder="Enter Qalification" />
								</div>
							</div>
                        </div>
						<div class="col-md-6">
